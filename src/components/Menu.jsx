...
const Menu = () => {
  return (
    <div className="max-w-[1200px] mx-auto my-20">
      <div className="rounded-xl w-full bg-[#dedede] pb-20">
        <div className="flex justify-center items-center">
          <button className="rounded-md text-4xl bg-[#DBA50F] -mt-7 cursor-default px-4 py-2 text-white navbar tracking-wider">
            OUR MENUS
          </button>
        </div>
        <ul className="flex gap-12 text-[#6c6c6c] text-lg navbar justify-center items-center mt-20">
        ...
        <div className="grid grid-cols-4 place-items-center gap-8 mx-10 mt-10">
            ...
            <div className="max-w-sm overflow-hidden h-full" key={index}>
              ...
              <div className="flex justify-center items-center -mt-12">
                <div className="rounded-xl flex-col flex text-center bg-white w-48 h-48 p-8">
                  <h2 className="font-[500] uppercase text-xl outlet">
                    {menu.name}
                  </h2>
                  <span className="mt-2 navbar">{menu.description}</span>
                </div>
              </div>
            </div>
          ))}
